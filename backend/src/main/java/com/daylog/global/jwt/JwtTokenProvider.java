...
public class JwtTokenProvider {
    ...
    public JwtToken generateToken(String email, Long userId, Long coupleId) {
    ...
    public JwtToken generateToken(Authentication authentication, Long userId, Long coupleId) {
